...
OUT_DIR = Path("results_stage3_persistent_stop_v4_validate")
...
rule("STAGE 3 — PERSISTENT ENDPOINT STOP V4 VALIDATION")
...
rule("V4 VALIDATION — FULL DETAILED FLIGHT")
...
rule("STAGE 3 PERSISTENT STOP V4 VALIDATION RESULT")
