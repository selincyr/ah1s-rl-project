...
class HelicopterEnv(gym.Env):
    ...
    def _update_phase(self, altitude):
        # V13 keeps the 300-ft mission structure.
    ...
    def _target_vertical_speed(self, altitude):
        # The proven vertical-speed schedule is retained unchanged in V13.
        if altitude < 30.0:
            return 6.0
    ...
    def step(self, action):
        ...
        # ==========================================================
        # V13 CURRICULUM REWARD: 300 FT STABLE HOVER
        # ==========================================================

        # Circular heading cost. 0 rad -> 0, pi rad -> 2.
        heading_cost = 1.0 - np.cos(heading_error)

        # V13: continuous circular heading cost. Keep it firm but not dominant,
        ...
        # ==========================================================
        # V13 TAKEOFF-ORIGIN / VERTICAL-CORRIDOR SHAPING
        # ==========================================================
        # Velocity alone is not enough: the helicopter must remain near the
        # point from which it took off. The penalty starts gently near the
        # centerline and becomes much stronger outside the corridor.
        reward -= 0.10 * horizontal_distance

        if horizontal_distance > 5.0:
            corridor_excess = horizontal_distance - 5.0
            reward -= 0.06 * (corridor_excess ** 2)

        if horizontal_distance > 12.0:
            corridor_excess = horizontal_distance - 12.0
            reward -= 0.18 * (corridor_excess ** 2)
        ...
        # ==========================================================
        # V13 STRAIGHT-CLIMB STABILIZATION
        # ==========================================================
        ...
        if 30.0 < altitude < 260.0:
            ...
            reward -= 0.16 * horizontal_distance
        ...
        # ==========================================================
        # V13 HORIZONTAL-DRIFT SHAPING (285 FT+)
        # ==========================================================
        ...
        # ==========================================================
        # V13 COMBINED HOVER-ACQUISITION BONUS
        # ==========================================================
        ...
        # ==========================================================
            ...
            # V13: once in hover acquisition, translation and yaw must
