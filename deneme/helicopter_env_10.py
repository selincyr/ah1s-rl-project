...
class HelicopterEnv(gym.Env):
    ...
    def _update_phase(self, altitude):
        # V10 keeps the successful V9 mission structure.
        # HOVER here means level-off / hover-acquisition starts at 285 ft.
        if altitude < 30.0:
            self.phase = "TAKEOFF"
        elif altitude < 285.0:
            self.phase = "CLIMB"
    ...
    def step(self, action):
        ...
        # ==========================================================
        # V10 CURRICULUM REWARD: 300 FT STABLE HOVER
        # ==========================================================

        # Circular heading cost. 0 rad -> 0, pi rad -> 2.
        heading_cost = 1.0 - np.cos(heading_error)

        # V10: slightly stronger heading preservation than V9.
        ...
        # ==========================================================
        # V10 STRAIGHT-CLIMB STABILIZATION
        # ==========================================================
        ...
        # ==========================================================
        # V10 TARGET APPROACH / LEVEL-OFF
        # ==========================================================
        # V9 BEST reaches 300 ft with good roll/forward control,
        # but keeps climbing and overshoots. V10 changes only the
        # target-acquisition behavior near 300 ft.
        if altitude >= 260.0:
            ...
            # Preserve heading during the level-off.
            reward -= 1.20 * abs(heading_error)
            reward -= 0.60 * abs(yaw_rate)
