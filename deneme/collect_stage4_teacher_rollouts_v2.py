...
RESULT_DIR = Path(
    "results_stage4_teacher_rollouts_v2"
)
...
FULL_RESULT_DIR = Path("results_stage4_teacher_rollouts_v2")
...
DATASET_DIR = Path("results_stage4_teacher_rollouts_v2")
...
rule("C — ROLLOUT COLLECTION V1 CONCLUSION")
