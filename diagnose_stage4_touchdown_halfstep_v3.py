...
RESULT_DIR = Path(
    "results_stage4_touchdown_halfstep_v3"
)
...
rule("C — HALF-STEP CONTACT CONTINUATION")
...
rule("D — HALF-STEP TOUCHDOWN V3 CONCLUSION")
...
if fc is not None:
    print(
        ...
        f"reduction={fc['collective_reduction']:.4f} | "
...
save_rows_csv(
    RESULT_DIR / "halfstep_extension_levels.csv",
    extension_rows,
)
save_rows_csv(
    RESULT_DIR / "halfstep_traces.csv",
    trace_rows,
)
save_rows_csv(
...
print(f"  {RESULT_DIR / 'halfstep_extension_levels.csv'}")
print(f"  {RESULT_DIR / 'halfstep_traces.csv'}")
print(f"  {RESULT_DIR / 'post_contact_observation.csv'}")
print(f"  {RESULT_DIR / 'final_summary.json'}")
print()
print(
    "Do NOT train Stage 4 here. "
    "This V3 starts from the confirmed reduction=0.008 equilibrium and "
    "uses only 0.0005 collective increments until actual WOW/compression "
    "is measured or a safety/equilibrium gate stops the search."
)
