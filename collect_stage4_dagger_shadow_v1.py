...
FULL_RESULT_DIR = Path("results_stage4_dagger_shadow_v1")
...
OBS_NORM_PATH = Path(
    "models_stage4_distilled_bc_v1/stage4_obs_normalization.npz"
)
ACTION_MAP_PATH = Path(
    "models_stage4_distilled_bc_v1/stage4_action_mapping.npz"
)
...
# =====================================================================
# STAGE-4 DAgger-STYLE SHADOW TEACHER COLLECTION V1
# =====================================================================
#
...
DAGGER_MIN_VS_FPS = -2.00
DAGGER_MAX_DESCENT_TIME_S = 180.0

DAGGER_BASE_WEIGHT = 1.0
DAGGER_COLLECTIVE_DELTA_SCALE = 0.0020
DAGGER_MAX_PRIORITY_WEIGHT = 5.0
...
def run_shadow_rollout(
    ...
    for step in range(int(DAGGER_MAX_DESCENT_TIME_S / dt)):
        ...
        if detailed and (
            step == 0
            or step % max(1, int(round(10.0 / dt))) == 0
        ):
            print(
        ...
        if state["vertical_speed_fps"] <= DAGGER_MIN_VS_FPS:
            termination = "dagger_vs_guard"
            break
...
summary = {
    ...
    "dagger_vs_guard_fps": float(DAGGER_MIN_VS_FPS),
...
rule("D — DAgger SHADOW COLLECTION V1 CONCLUSION")

print(f"corrective samples: {len(obs)}")
print(
