...
MODEL_PATHS = [
    (
        "BEST",
        "models/task12_hover300/best/best_model"
    ),
    (
        "FINAL",
        "models/task12_hover300/ppo_ah1s_hover300_v12_final"
    )
]
        ...
        if (
            ...
            if (
                ...
                best_hover_snapshot = {
                    ...
                    "pitch": pitch,
                    "hold": hold,
                    "collective_action": float(action[0]),
                    "elevator_action": float(action[1]),
                    "aileron_action": float(action[2]),
                    "rudder_action": float(action[3])
                }
