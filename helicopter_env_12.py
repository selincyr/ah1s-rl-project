...
class HelicopterEnv(gym.Env):
    ...
    def _update_phase(self, altitude):
        # V12 keeps the successful V10 mission structure.
    ...
    def _target_vertical_speed(self, altitude):
        # V10 vertical-speed schedule retained unchanged in V12.
        if altitude < 30.0:
            return 6.0
    ...
    def step(self, action):
        ...
        # ==========================================================
        # V12 CURRICULUM REWARD: 300 FT STABLE HOVER
        # ==========================================================

        # Circular heading cost. 0 rad -> 0, pi rad -> 2.
        heading_cost = 1.0 - np.cos(heading_error)

        # V12: continuous circular heading cost. Keep it firm but not dominant,
        ...
        # ==========================================================
        # V12 STRAIGHT-CLIMB STABILIZATION
        # ==========================================================
        ...
        # ==========================================================
        # V12 HORIZONTAL-DRIFT SHAPING (285 FT+)
        # ==========================================================
        ...
        # ==========================================================
        # V12 COMBINED HOVER-ACQUISITION BONUS
        # ==========================================================
        ...
        # ==========================================================
            ...
            # V12: once in hover acquisition, translation and yaw must
