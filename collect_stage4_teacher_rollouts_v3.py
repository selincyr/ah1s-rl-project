...
RESULT_DIR = Path(
    "results_stage4_teacher_rollouts_v3"
)
...
FULL_RESULT_DIR = Path("results_stage4_teacher_rollouts_v3")
...
DATASET_DIR = Path("results_stage4_teacher_rollouts_v3")
...
rule("C — ROLLOUT COLLECTION V3 CONCLUSION")
