...
class HelicopterEnv(gym.Env):
    ...
    def _update_phase(self, altitude):
        # V4 keeps the successful V2 reward structure and changes only
        # the late-climb schedule. This isolates whether earlier level-off
        # solves the instability seen near the top of the climb.
        if altitude < 30.0:
            self.phase = "TAKEOFF"
        elif altitude < 800.0:
            self.phase = "CLIMB"
