...
class HelicopterEnv(gym.Env):
    ...
    def __init__(self):
        ...
        # Yaklaşık 7.5 saniye stabil kalma
    ...
    def step(self, action):
        ...
        # 10 JSBSim physics steps per RL step
        for _ in range(10):
        ...
        # Hedefin altındayken gereksiz alçalma
        if (
            altitude
