...
print("Stage-4 teacher V2 target: early qualified transfer -> >=5 s endpoint hold -> stable 30 ft AGL hover")
...
rule("B — STAGE-4 DESCENT TEACHER V2 SWEEP (QUALIFIED EARLY ENTRY -> 30 ft)")
...
print(
    ...
    f"fixed A1={FIXED_BRAKE_A1:+.2f}; LAT Kp={LATERAL_KP:.3f}, Kd={LATERAL_KD:.2f}"
)
...
final_summary = {
    "stage": "Stage 4 descent teacher V2: qualified early endpoint transition -> stable 30 ft AGL hover",
...
rule("STAGE 4 DESCENT TEACHER V2 — RESULT")
print(
